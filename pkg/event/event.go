...
type CreateEvent struct {
	// Object is the created object from the event
...
type UpdateEvent struct {
	// ObjectOld is the old object from the event
	ObjectOld client.Object

	// ObjectNew is the new object from the event
...
type DeleteEvent struct {
	// Object is the deleted object from the event
	Object client.Object
...
// GenericEvent should be generated by a source.Source and transformed into a reconcile.Request by a
